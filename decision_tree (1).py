...
# SPECIFICATION: find lowest accurasy as final classification performance of each model
...
for ds in dataSets:
    ...
    print("the 4d array is: ", X)

    #transform the original training classes to numbers and add to the vector Y. For instance Yes = 1, No = 2, so Y = [1, 1, 2, 2, ...]
    #--> add your Python code here
    tClass = dbTraining[4::5]
    for tClass in dbTraining:
        if tClass=="Yes":
            Y.append(1)
        elif tClass=="No":
            Y.append(2)
    
    print("the Y vector is ", Y)
    ...
    for i in range (10):
       ...
       for data in dbTest:
           ...
           class_predicted = clf.predict[(0)*4][0]
